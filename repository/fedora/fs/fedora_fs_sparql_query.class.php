...
/**
 * Helper class for generating the text representation of a SPARCL query based on keywork search.
 * 
 * Not a FS object as per see as it doesn't inherit from fedora_fs_base.
 * 
