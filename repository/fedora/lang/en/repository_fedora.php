...
$string['repositorydesc'] = 'Fedora repository';
...
$string['search_level'] = 'Search level';
$string['exact'] = 'Exact';
$string['wildcard'] = 'Wildcard';
$string['fuzzy'] = 'Fuzzy';
$string['regex'] = 'Regex';
$string['best_effort'] = 'Best effort';

$string['hit_page_size'] = 'Hit page size';
$string['hit_page_start'] = 'Hit page start';
$string['my_stuff'] = 'My stuff';

$string['sort'] = 'Sort';
$string['by_relevance_ascending'] = 'By relevance ascending';
$string['by_relevance_descending'] = 'By relevance descending';
$string['by_title_ascending'] = 'By title ascending';
$string['by_title_descending'] = 'By title descending';
$string['by_date_ascending'] = 'By date ascending';
$string['by_date_descending'] = 'By date descending';
$string['by_author_ascending'] = 'By author ascending';
$string['by_author_descending'] = 'By author descending';
...
$string['two_weeks_ago'] = 'Two weeks ago';
$string['three_weeks_ago'] = 'Three weeks ago';
$string['history'] = 'History';
$string['root'] = 'Root';
$string['lastobjects'] = 'Last objects';
