...
/**
 * Implementation of the UniGe API.
 ...
 *
 */
class UniGe_portfolio_api extends api_base {
    ...
    public function export_config_form(&$mform) {
        ...
        $mform->addElement('hidden', 'owner', get_string('owner', 'portfolio_fedora'), array('size' => $size, 'readonly' => 'readonly'));
    ...
    public function content_to_foxml($content, $meta, $export_config) {
        ...
        $switch->aaiid= empty($switch->aaiid) ? $meta->owner : $switch->aaiid;
